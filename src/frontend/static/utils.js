...
function beforeNow(timestamp) {
    var tzDifference = 1;
    var current = new Date();
    t = new Date(timestamp);
    t = t.setTime(t.getTime() + (tzDifference * 3600000))
    return timeDifference(current, t);
}
